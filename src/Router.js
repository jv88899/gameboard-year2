...
import Transaction045 from "./transactions/Transaction045";
import Transaction046 from "./transactions/Transaction046";
import Transaction047 from "./transactions/Transaction047";
import Transaction048 from "./transactions/Transaction048";
import Transaction049 from "./transactions/Transaction049";
import Transaction050 from "./transactions/Transaction050";
import Transaction051 from "./transactions/Transaction051";
import Transaction052 from "./transactions/Transaction052";
import Transaction053 from "./transactions/Transaction053";
import Transaction054 from "./transactions/Transaction054";
  ...
  return (
    <BrowserRouter>
      <Switch>
        ...
        <Route path="/045" exact>
          <Transaction045 companyName={companyName} />
        </Route>
        <Route path="/046" exact>
          <Transaction046 companyName={companyName} />
        </Route>
        <Route path="/047" exact>
          <Transaction047 companyName={companyName} />
        </Route>
        <Route path="/048" exact>
          <Transaction048 companyName={companyName} />
        </Route>
        <Route path="/049" exact>
          <Transaction049 companyName={companyName} />
        </Route>
        <Route path="/050" exact>
          <Transaction050 companyName={companyName} />
        </Route>
        <Route path="/051" exact>
          <Transaction051 companyName={companyName} />
        </Route>
        <Route path="/052" exact>
          <Transaction052 companyName={companyName} />
        </Route>
        <Route path="/053" exact>
          <Transaction053 companyName={companyName} />
        </Route>
        <Route path="/054" exact>
          <Transaction054 companyName={companyName} />
        </Route>
      </Switch>
    </BrowserRouter>
  );
