  ...
  const [transactions, setTransactions] = useState([
    {
      ...
      route: `001`,
      description: `Collect $10 for sale to customers for Year 2; Recognize $10 received in Year 1 for Year 2`,
      activeStep: null,
      previousStep: null,
      visible: true,
    ...
    },
    {
      ...
      route: `012`,
      description: `Pay $6 of actual prescriptions filled; Increase due to new, unexpected specialty drug introduced to market`,
      activeStep: null,
      previousStep: null,
      visible: true,
      isCashTransaction: false
    },
    {
      ...
      route: `015`,
      description: `$10 of actual medical visits; claim received`,
      activeStep: null,
      previousStep: null,
      visible: true,
      isCashTransaction: false
    },
    {
      ...
      route: `017`,
      description: `Estimated claims of $3 not received for Year 2`,
      activeStep: null,
      previousStep: null,
      visible: true,
      isCashTransaction: false
    ...
    },
    {
      ...
      route: `022`,
      description: `Pay $9 of known medical claims for Year 2`,
      activeStep: null,
      previousStep: null,
      visible: true,
      isCashTransaction: false
    },
    {
      ...
      route: `025`,
      description: `Pay $2 to Medica's employees`,
      activeStep: null,
      previousStep: null,
      visible: true,
      isCashTransaction: false
    ...
    },
    {
      ...
      route: `038`,
      description: `Use 1/5th of 401 and 301 Carlson Parkway buildings for Year 2`,
      activeStep: null,
      previousStep: null,
      visible: true,
      isCashTransaction: false
